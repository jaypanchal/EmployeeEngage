...
public class EmployeeController {
	...
	public ModelAndView createEmployee(@ModelAttribute Employee employee) {
		System.out.println("Creating Employee. Data: " + employee);
		return new ModelAndView("employeeForm");
	}

	@RequestMapping("editEmployee")
	public ModelAndView editEmployee(@RequestParam long id, @ModelAttribute Employee employee) {
		System.out.println("Updating the Employee for the Id " + id);
	...
	public ModelAndView saveEmployee(@ModelAttribute Employee employee) {
		System.out.println("Saving the Employee. Data : " + employee);
	...
	public ModelAndView deleteEmployee(@RequestParam long id) {
		System.out.println("Deleting the Employee. Id : " + id);
	...
	public ModelAndView getAllEmployees() {
		System.out.println("Getting the all Employees.");
	...
	public ModelAndView searchEmployee(@RequestParam("searchName") String searchName) {
		System.out.println("Searching the Employee. Employee Names: " + searchName);
